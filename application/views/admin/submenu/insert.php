        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-outline-info">
                    <div class="card-body">
                        <form action="<?= site_url('admin/Submenu/insert') ?>" method="post" class="form-horizontal">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="submenu_title" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a href="<?= site_url('admin/Submenu/InsertForm') ?>" class="btn btn-default">Back</a>
                                            </div>
                                        </div>
                                    </div>
