...
<section class="signup">
    <div class="container">
        <div class="row">
            <form id="signup-form" class="w-100" action="<?= site_url('site/Account/insert') ?>" method="post">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="wrap-input100 validate-input" data-validate="Username is required">
                                <label for="username-signup" class="label-input100">Username *</label>
                                <input id="username-signup" class="input100" type="text" name="person_username" required="required" placeholder="Username...">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                                ...
                                <input id="email"  class="input100" type="email" name="person_email" required="required" placeholder="Email address...">
                                <span class="focus-input100"></span>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="wrap-input100 validate-input" data-validate="Password is required">
                                <label for="password-signup" class="label-input100">Password *</label>
                                <input class="input100" id="password-signup" type="password" name="person_password" required="required" placeholder="Password ..." >
                                <span class="focus-input100"></span>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="wrap-input100 validate-input" data-validate="Confirm Password is required">
                                <label for="confirm-password" class="label-input100">Confirm Password *</label>
                                <input class="input100" type="password" name="confirm-password" id="confirm-password" required="required" placeholder="Comfirm Password...">
                                <span class="focus-input100"></span>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="wrap-input100 validate-input" data-validate="Name is required">
                                ...
                                <input id="firstname"  class="input100" type="text" name="person_fn" required="required" placeholder="First Name...">
                                <span class="focus-input100"></span>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="wrap-input100 validate-input" data-validate="Name is required">
                                ...
                                <input id="lastname"  class="input100" type="text" name="person_ln" required="required" placeholder="Last Name...">
                                <span class="focus-input100"></span>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="wrap-input100 validate-input" data-validate="Birthday is required">
                                ...
                                <input class="input100" type="date" name="person_birthday" required="required" placeholder="Birthday...">
                                <span class="focus-input100"></span>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="flex-m w-full h-100 p-b-33">
                                <div class="contact100-form-checkbox">
                                    <input class="input-checkbox100" name="person_ruls" id="ckb1" type="checkbox" required="required" name="remember-me">
                        ...
                        <div class="col-12 pb-4">
                            <button style="z-index:10000;" type="submit" id="submitSignupForm" rel="no-follow" class="primary_btn gradient-bg btn-submit">Sign Up</button>
                        </div>
                    </div>
                </div>
            </form>
